...
# Cross Attention
_C.MODEL.AFTER_PATCH = True
# Loss weight of deep supervision: loss0, loss1, loss2, loss3, loss4 (main)
_C.MODEL.LOSS_WEIGHT = [0.01, 0.01, 0.01, 0.01, 1.0]
_C.MODEL.HEAD_DROP_RATE = 0.5
_C.MODEL.CA = True
_C.MODEL.CA_FLAG = [True, True, True, True]
...
_C.FUSED_LAYERNORM = True

# for visualization
_C.RETURN_FEATURE = False
_C.RETURN_ATTN = False
_C.RETURN_XFEATURE = False
